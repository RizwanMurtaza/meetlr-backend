...
public record CreateRecurringBookingResponse
{
    ...
    public static CreateRecurringBookingResponse FromCommandResponse(CreateRecurringBookingCommandResponse response)
    {
        return new CreateRecurringBookingResponse
        {
